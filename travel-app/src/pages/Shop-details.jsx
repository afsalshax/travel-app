    ...
    <section class="product-details space-top space-extra-bottom">
      <div class="container">
          ...
          <div class="col-lg-6 align-self-center">
            <div class="product-about">
              ...
              <p class="text">
                ...
                listen to music, podcasts, or make calls without being tethered
                to their device
              </p>
              ...
              <div class="product_meta">
                <span class="sku_wrapper"
                  >SKU: <span class="sku">BH-1001-BT</span></span
                >
                <span class="posted_in"
                  >Category:
                  <a href="shop.html">sports, gaming, music listening</a></span
                >
                <span
                  >Tags: <a href="shop.html">Wireless</a
                  ><a href="shop.html">Sports</a></span
                >
              </div>
            </div>
          </div>
        ...
        <div class="tab-content" id="productTabContent">
          ...
          >
            <p>
              Bluetooth headphones are a wireless audio accessory that connects
              to your devices, like smartphones, tablets, or computers, via
              Bluetooth technology. Here's a typical description Introducing our
              [Brand Name] Bluetooth Headphones, the ultimate companion for your
              on-the-go audio experience. Immerse yourself in high-fidelity
              sound without the hassle of wires, thanks to the latest Bluetooth
              technology Featuring [insert standout features such as noise
              cancellation, long battery life, etc.], our headphones deliver
              crystal-clear audio while providing unmatched comfort during
              extended listening sessions. Designed for convenience and
              portability, our sleek and lightweight headphones fold easily for
              storage and travel. The adjustable headband ensures a secure and
              comfortable fit for all head shapes and sizes.
            </p>
          </div>
          <div
            class="tab-pane fade"
          ...
          >
            <p>
              ...
              long-lasting rechargeable battery. Whether you're on a long flight
              or a marathon study session, our headphones have you covered.
              Immersive Sound Experience: Experience rich, immersive sound with
              powerful bass and crisp highs. Our headphones are engineered to
              deliver audio that's true to the artist's intention, whether
              you're listening to music, podcasts, or watching movies.
              Comfortable Ergonomic Design: Designed for extended wear, our
              headphones feature plush ear cushions and an adjustable headband
              for a comfortable fit. Say goodbye to discomfort, even during
              marathon listening sessions. Foldable and Portable: Our headphones
              are designed to go wherever you do. Easily fold them up and toss
              them in your bag for on-the-go convenience. Whether you're
              traveling, commuting, or hitting the gym, take your music with you
              everywhere. Intuitive Controls: Control your music, adjust volume,
              and take calls with ease using the intuitive onboard controls. No
              need to fumble with your device—everything you need is right at
              your fingertips.
            </p>
          </div>
          <div
                    ...
                    <div class="th-post-comment">
                      ...
                      <div class="comment-content">
                        ...
                        <span class="commented-on"
                          ><i class="far fa-calendar"></i>22 April, 2023</span
                        >
                        <div
                          class="star-rating"
                          role="img"
                  ...
                  <li class="review th-comment-item">
                    <div class="th-post-comment">
                      ...
                      <div class="comment-content">
                        ...
                        <span class="commented-on"
                          ><i class="far fa-calendar"></i>26 April, 2023</span
                        >
                        <div
                          class="star-rating"
                          role="img"
                ...
                <div class="th-product">
                  ...
                  <div class="product-content">
                    ...
                    <h3 class="product-title">
                      <a href="shop-details.html">Flooring-Vinyl</a>
                    </h3>
              ...
              <div class="swiper-slide style2">
                <div class="th-product">
                  ...
                  <div class="product-content">
                    ...
                    <h3 class="product-title">
                      <a href="shop-details.html">Cement Metal Roof</a>
                    </h3>
                    <div class="woocommerce-product-rating">
                      <div
                        class="star-rating"
              ...
              <div class="swiper-slide style2">
                <div class="th-product">
                  ...
                  <div class="product-content">
                    ...
                    <h3 class="product-title">
                      <a href="shop-details.html">Metal Roof Steel</a>
                    </h3>
                    <div class="woocommerce-product-rating">
                      <div
                        class="star-rating"
              ...
              <div class="swiper-slide style2">
                <div class="th-product">
                  ...
                  <div class="product-content">
                    ...
                    <h3 class="product-title">
                      <a href="shop-details.html">Roof Tiles Braas</a>
                    </h3>
                    <div class="woocommerce-product-rating">
                      <div
                        class="star-rating"
              ...
              <div class="swiper-slide style2">
                <div class="th-product">
                  ...
                  <div class="product-content">
                    ...
                    <h3 class="product-title">
                      <a href="shop-details.html">Ceramic Roof</a>
                    </h3>
                    <div class="woocommerce-product-rating">
                      <div
                        class="star-rating"
              ...
              <div class="swiper-slide style2">
                <div class="th-product">
                  ...
                  <div class="product-content">
                    ...
                    <h3 class="product-title">
                      <a href="shop-details.html">Wall Formwork</a>
                    </h3>
                    <div class="woocommerce-product-rating">
                      <div
                        class="star-rating"
              ...
              <div class="swiper-slide style2">
                <div class="th-product">
                  ...
                  <div class="product-content">
                    <span class="price">$235.00</span>
                    <h3 class="product-title">
                      <a href="shop-details.html">Flashing Roof</a>
                    </h3>
                    <div class="woocommerce-product-rating">
                      <div
                        class="star-rating"
              ...
              <div class="swiper-slide style2">
                <div class="th-product">
                  ...
                  <div class="product-content">
                    <span class="price">$250.00<del>$550.00</del></span>
                    <h3 class="product-title">
                      <a href="shop-details.html">Roof Topwet</a>
                    </h3>
                    <div class="woocommerce-product-rating">
                      <div
                        class="star-rating"
