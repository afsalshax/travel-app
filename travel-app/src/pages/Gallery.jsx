...
function Gallery() {
  return (
    <div>
    <div class="breadcumb-wrapper" style={{ backgroundImage: "url('/assets/img/bg/breadcumb-bg.jpg')" }}>
      <div class="container">
        ...
        <div class="row gy-4 gallery-row4">
          <div class="col-auto">
            <div class="gallery-box style5">
              <div class="gallery-img global-img">
                <img
                  src="assets/img/gallery/gallery_8_1.jpg"
                  alt="gallery image"
                />
                <a
          ...
          <div class="col-auto">
            <div class="gallery-box style5">
              <div class="gallery-img global-img">
                <img
                  src="assets/img/gallery/gallery_8_2.jpg"
                  alt="gallery image"
                />
                <a
          ...
          <div class="col-auto">
            <div class="gallery-box style5">
              <div class="gallery-img global-img">
                <img
                  src="assets/img/gallery/gallery_8_3.jpg"
                  alt="gallery image"
                />
                <a
          ...
          <div class="col-auto">
            <div class="gallery-box style5">
              <div class="gallery-img global-img">
                <img
                  src="assets/img/gallery/gallery_8_4.jpg"
                  alt="gallery image"
                />
                <a
          ...
          <div class="col-auto">
            <div class="gallery-box style5">
              <div class="gallery-img global-img">
                <img
                  src="assets/img/gallery/gallery_8_5.jpg"
                  alt="gallery image"
                />
                <a
          ...
          <div class="col-auto">
            <div class="gallery-box style5">
              <div class="gallery-img global-img">
                <img
                  src="assets/img/gallery/gallery_8_6.jpg"
                  alt="gallery image"
                />
                <a
          ...
          <div class="col-auto">
            <div class="gallery-box style5">
              <div class="gallery-img global-img">
                <img
                  src="assets/img/gallery/gallery_8_7.jpg"
                  alt="gallery image"
                />
                <a
          ...
          <div class="col-auto">
            <div class="gallery-box style5">
              <div class="gallery-img global-img">
                <img
                  src="assets/img/gallery/gallery_8_8.jpg"
                  alt="gallery image"
                />
                <a
