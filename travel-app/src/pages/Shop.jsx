              ...
              <div class="row gy-40">
                ...
                <div class="col-xl-3 col-sm-6">
                  <div class="th-product product-grid">
                    ...
                    <div class="product-content">
                      <h3 class="product-title">
                        <a href="shop-details.html">Beach Hat</a>
                      </h3>
                ...
                <div class="col-xl-3 col-sm-6">
                  <div class="th-product product-grid">
                    ...
                    <div class="product-content">
                      <h3 class="product-title">
                        <a href="shop-details.html">Sony Black Headphone</a>
                      </h3>
                ...
                <div class="col-xl-3 col-sm-6">
                  <div class="th-product product-grid">
                    ...
                    <div class="product-content">
                      <h3 class="product-title">
                        <a href="shop-details.html">Hoodie With Zipper</a>
                      </h3>
                      <span class="price">$35.00</span>
                      <div class="woocommerce-product-rating">
                        <span class="count">(5.00 Review)</span>
                ...
                <div class="col-xl-3 col-sm-6">
                  <div class="th-product product-grid">
                    ...
                    <div class="product-content">
                      <h3 class="product-title">
                        <a href="shop-details.html">Trendy Sunglass</a>
                      </h3>
                ...
                <div class="col-xl-3 col-sm-6">
                  <div class="th-product product-grid">
                    ...
                    <div class="product-content">
                      <h3 class="product-title">
                        <a href="shop-details.html">V-Neck T-Shirt</a>
                      </h3>
                      <span class="price">$35.00</span>
                      <div class="woocommerce-product-rating">
                        <span class="count">(5.00 Review)</span>
