            ...
            <div className="page-single">
              ...
              <div className="page-content d-block">
                <div className="page-meta mt-50 mb-45">
                  <Link to="/tour"  className="page-tag">Featured</Link>
          ...
          <div className="col-xxl-4 col-lg-5">
            <aside className="sidebar-area style3">
              ...
              <div className="widget widget_categories">
                ...
                <ul>
                  <li>
                   <Link to="/blog"><img src="assets/img/theme-img/map.svg" alt="" />City
                      Tour</Link>
                    <span>(8)</span>
                  </li>
                  <li>
                    <Link to="/blog"><img src="assets/img/theme-img/map.svg" alt="" />Beach
                      Tours</Link>
                    <span>(6)</span>
                  </li>
                  <li>
                   <Link to="/blog"><img src="assets/img/theme-img/map.svg" alt="" />Wildlife
                      Tours</Link>
                    <span>(2)</span>
                  </li>
                  <li>
                   <Link to="/blog"><img src="assets/img/theme-img/map.svg" alt="" />News &
                      Tips</Link>
                    <span>(7)</span>
                  </li>
                  <li>
                  ...
                  <div className="recent-post">
                    ...
                    <div className="media-body">
                      ...
                      <div className="recent-post-meta">
                        <Link to="/blog"><i className="fa-regular fa-calendar"></i>22/6/ 2025</Link>
                      </div>
                    </div>
                  </div>
                  <div className="recent-post">
                    ...
                    <div className="media-body">
                      ...
                      <div className="recent-post-meta">
                        <Link to="/blog"><i className="fa-regular fa-calendar"></i>25/6/ 2025</Link>
                      </div>
                    </div>
                  </div>
                  <div className="recent-post">
