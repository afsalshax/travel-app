  ...
  return (
          ...
          <div class="col-lg-5 pe-xl-4 ps-xl-4">
            ...
            <form class="newsletter-form style3">
              <input
                ...
                required=""
              />
              <button type="submit" class="th-btn style1 btn-fw">
    ...
    <div class="faq-area space-top space-extra-bottom">
            ...
            <div class="accordion-area accordion mb-30" id="faqAccordion">
                ...
                >
                  <div class="accordion-body style2">
                    <p class="faq-text">
                      ...
                      the area. Knowing the market will give you leverage during
                      negotiations
                    </p>
                  </div>
                </div>
              ...
              <div class="accordion-card style2">
                <div class="accordion-header" id="collapse-item-4">
                  ...
                  >
                    Q4. What are closing costs and who is responsible for paying
                    them?
                  </button>
                </div>
                <div
                ...
                >
                  <div class="accordion-body style2">
                    <p class="faq-text">
                      ...
                      sales prices of similar properties, and the overall supply
                      and demand dynamics in the area. This knowledge will help
                      you determine a fair market value for the property you're
                      interested in
                    </p>
                  </div>
                </div>
                ...
                >
                  <div class="accordion-body style2">
                    <p class="faq-text">
                      ...
                      financial situation, including your down payment, mortgage
                      pre-approval, and ongoing expenses. Knowing your financial
                      limits will prevent you from overextending yourself during
                      negotiations.
                    </p>
                  </div>
                </div>
              ...
              <div class="accordion-card style2 loadcontent">
                ...
                >
                  <div class="accordion-body style2">
                    <p class="faq-text">
                      Understand that negotiation is a give-and-take process. Be
                      willing to walk away from a deal if the terms are not
                      favorable or if the seller is not willing to negotiate in
                      good faith. This demonstrates to the seller that you're
                      serious and can sometimes prompt them to reconsider their
                      position.
                    </p>
                  </div>
                </div>
                ...
                >
                  <div class="accordion-body style2">
                    <p class="faq-text">
                      ...
                      position, emphasize this to the seller. Sellers are often
                      more willing to negotiate with buyers who are
      ...
      <div class="th-loader btn-group mt-5 d-flex justify-content-center">
        <a href="#" class="th-btn style3 th-icon" id="loadMore"
