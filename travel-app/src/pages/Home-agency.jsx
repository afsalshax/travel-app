...
function Homeagency() {
  return (
              ...
              <div class="container">
                <div class="hero-style3">
                  ...
                  <div
                    ...
                    data-ani-delay="0.6s"
                  >
                    <a href="tour.html" class="th-btn style2 th-icon"
                      >Explore Tours</a
                    >
                  </div>
                </div>
    ...
    <section
      class="category-area3 bg-smoke space"
      data-bg-src="assets/img/bg/line-pattern3.png"
    >
    ...
    <section
      class="tour-area3 position-relative bg-top-center overflow-hidden space"
      id="service-sec"
    ...
    <div
      class="contact-area3 bg-top-center overflow-hidden"
    ...
    <section
      class="testi-area3 bg-bottom-center overflow-hidden space"
      id="testi-sec"
