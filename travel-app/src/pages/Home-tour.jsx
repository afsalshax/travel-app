...
function Hometour() {
  return (
    ...
    <div class="hero-2" id="hero">
      ...
      <div class="swiper hero-slider-2" id="heroSlide2">
              ...
              <div class="container">
                <div class="hero-style2">
                  ...
                  <div
                    ...
                    data-ani-delay="0.6s"
                  >
                    <a href="tour.html" class="th-btn white-btn th-icon"
                      >Explore Tours</a
                    >
                  </div>
                </div>
        ...
        <div class="th-swiper-custom">
          ...
          <div class="hero-icon">
            <button
              data-slider-prev="#heroSlide2, #heroSlide3"
              class="hero-arrow slider-prev"
            >
              <img src="assets/img/icon/hero-arrow-left.svg" alt="" />
            </button>
            <button
              data-slider-next="#heroSlide2, #heroSlide3"
              class="hero-arrow slider-next"
            >
    ...
    <div
      class="bg-top-center position-relative space overflow-hidden"
      id="destination-sec"
    ...
    <section class="category-area2 bg-top-center overflow-hidden">
    ...
    <div
      class="counter-sec2 space overflow-hidden"
      data-bg-src="assets/img/bg/line-pattern2.png"
    >
      <div class="container">
        <div class="row">
    ...
    <div
      class="gallery-area2 bg-top-center space overflow-hidden"
